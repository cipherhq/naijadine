...
export class NotificationsService {
  ...
  async sendWelcome(userId: string): Promise<void> {
    ...
    await this.dispatch({
      ...
      title: 'Welcome to DineRoot!',
      body: `Hi ${name}! Welcome to DineRoot. Discover the best dining experiences across Nigeria.`,
      emailHtml: email.html,
      emailSubject: email.subject,
  ...
  async sendRestaurantApproved(userId: string, restaurantName: string): Promise<void> {
    ...
    await this.dispatch({
      ...
      body: `Congratulations! ${restaurantName} is now live on DineRoot.`,
      emailHtml: email.html,
      emailSubject: email.subject,
