...
export default function ReservationsPage() {
  ...
  // Sync edit fields when selected reservation changes
  useEffect(() => {
          ...
          >
            ...
            <div className="sticky top-0 z-10 flex items-center justify-between border-b border-gray-100 bg-white px-6 py-4">
              <div>
                ...
                <span className={`mt-1 inline-flex rounded-full px-2 py-0.5 text-xs font-medium ${statusColors[selectedReservation.status] || 'bg-gray-100 text-gray-600'}`}>
            ...
            <div className="space-y-6 px-6 py-5">
              ...
              <div>
                ...
                {selectedReservation.guest_email && <p className="text-sm text-gray-500">{selectedReservation.guest_email}</p>}
              </div>
              ...
              <div>
                ...
                <div className="mt-2 grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-900">{selectedReservation.channel || 'web'}</p>
                  </div>
                </div>
              </div>
                ...
                <div>
                  ...
                  <div className="mt-1 flex items-center gap-2 text-sm">
                    <span className="font-medium text-gray-900">
                      {new Intl.NumberFormat('en-NG', { style: 'currency', currency: 'NGN', minimumFractionDigits: 0 }).format(selectedReservation.deposit_amount)}
                    </span>
                    <span className={`rounded-full px-2 py-0.5 text-xs font-medium ${
                      selectedReservation.deposit_status === 'paid' ? 'bg-green-100 text-green-700' :
                      selectedReservation.deposit_status === 'refunded' ? 'bg-blue-100 text-blue-700' :
                      selectedReservation.deposit_status === 'forfeited' ? 'bg-red-100 text-red-700' :
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    {nextActions[selectedReservation.status].map((action) => (
                      <button
                        ...
                        className={`rounded-lg px-3 py-2 text-sm font-medium ${action.color} border border-gray-200`}
                      >
                        {action.label}
                      </button>
                    ))}
